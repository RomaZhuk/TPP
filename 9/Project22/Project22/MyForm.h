...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Column3
			// 
			this->Column3->HeaderText = L"Посада";
			...
			// Column5
			// 
			this->Column5->HeaderText = L"Дата працевлаштування";
...
private: void CommonButtonClick2() {
	String^ connectionString = "provider=Microsoft.Jet.OLEDB.4.0;Data Source=Database7.mdb";
	OleDbConnection^ dbConnection = gcnew OleDbConnection(connectionString);
	...
	if (dbReader->HasRows == false) {
		...
		while (dbReader->Read())
			dataGridView1->Rows->Add(dbReader["ID"], dbReader["Ім'я"], dbReader["Посада"], dbReader["З/П"], dbReader["Дата працевлаштування"]);
...
private: System::Void проПрограмуToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Windows::Forms::MessageBox::Show("Програма з роботою БД \"Агенція з працевлаштування\"", "Увага", System::Windows::Forms::MessageBoxButtons::OK, System::Windows::Forms::MessageBoxIcon::Exclamation);
}
